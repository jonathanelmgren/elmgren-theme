        ...
        <div class="w-full relative border-b-2">
            <nav class="z-50 flex <?php elm_the_page_width(true) ?> items-center justify-between py-6" aria-label="Global">
                ...
                <div class="flex lg:hidden">
                    <button type="button" data-menu-toggle="open" class="btn--no-style inline-flex items-center justify-center rounded-md text-gray-700">
        ...
        <div class="lg:hidden hidden" role="dialog" aria-modal="true" data-menu="mobile">
            ...
            <div <?php echo $mobile_attrs ?>>
                <div class="flex items-center justify-between">
                    <?= get_logo_or_blog_name(); ?>
                    <button data-menu-toggle="close" type="button" class="btn--no-style rounded-md text-gray-700">
