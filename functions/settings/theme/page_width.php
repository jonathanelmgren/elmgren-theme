...
function elm_page_width_options($field)
{
    ...
    foreach (ELM_PAGE_WIDTHS as $label => $value) {
        $field['choices'][$value] = $label;
    }
    return $field;
}
add_filter('acf/load_field/name=page_width', 'elm_page_width_options');
add_filter('acf/load_field/name=default_page_width', 'elm_page_width_options');
